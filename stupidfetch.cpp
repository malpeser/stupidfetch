...
int main(int argc, char* argv[]) {
    ...
    if (!std::filesystem::exists(HOME+"default.conf")){
        ...
        if(configer)
        {
            ...
            "# Valid values are RED, GREEN, YELLOW, BLUE, CYAN, PURPLE, WHITE.\n" <<
            "COLOR=CYAN\n" <<
            ...
            "# Makes the info less accurate, but is like zillion times faster.\n" <<
            "GPU_FAST_LOOK=YES\n" <<
    ...
    std::string GETCOLOR = GetStrConfig(c,"COLOR"); // TODO: Better color system using full 256 colors
